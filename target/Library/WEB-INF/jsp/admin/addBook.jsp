...
<div class="container">
    ...
    <form action="<c:url value="/controller?command=addBook"/>" method="post">
        ...
        <input class="form-control" value="${sessionScope.todayDate}" type="date" placeholder="<fmt:message key="addBook.publishingDate"/>" max="${sessionScope.todayDate}" name="publishingDate" id="publishingDate" required><br>
